...
def test_find_elements_on_catalog_page(browser, base_url):
    ...
    group_items = browser.find_elements(
        By.CSS_SELECTOR,
...
def test_find_elements_on_products_page(browser, base_url):
    ...
    assert browser.find_elements(By.LINK_TEXT, "Samsung Galaxy Tab 10.1")
    assert browser.find_elements(By.XPATH, "//h1[text()='Samsung Galaxy Tab 10.1']")
    assert browser.find_elements(By.CSS_SELECTOR, "#button-cart")
...
def test_find_elements_on_login_page(browser, base_url):
    ...
    assert browser.find_elements(By.LINK_TEXT, "Login")
    assert browser.find_elements(By.XPATH, "//h2[text()='New Customer']")
    assert browser.find_elements(By.XPATH, "//h2[text()='Returning Customer']")
    assert browser.find_elements(By.LINK_TEXT, "Continue")
    assert browser.find_elements(By.CSS_SELECTOR, "[value='Login']")
    assert browser.find_elements(By.CSS_SELECTOR, "[name='email']")
    assert browser.find_elements(By.CSS_SELECTOR, "[name='password']")
    assert browser.find_elements(By.LINK_TEXT, "Forgotten Password")
...
def test_find_elements_on_login_admin_page(browser, base_url):
    ...
    assert browser.find_elements(By.CSS_SELECTOR, "[title='OpenCart']")
    assert browser.find_elements(By.CSS_SELECTOR, "#input-username")
    assert browser.find_elements(By.CSS_SELECTOR, "#input-password")
    assert browser.find_elements(By.LINK_TEXT, "Forgotten Password")
    assert browser.find_elements(By.CSS_SELECTOR, "button[type='submit']")
    assert browser.find_elements(By.XPATH, "//h1[text()=' Please enter your login details.']")
...
def test_go_to_products_in_admin_section(browser, base_url):
    ...
    el.click()
    assert browser.find_elements(By.CSS_SELECTOR, "#form-product")
...
def test_go_to_layouts_in_admin_section(browser, base_url):
    ...
    el.click()
    assert browser.find_elements(By.CSS_SELECTOR, ".panel-heading")
...
def test_go_to_admin_profile(browser, base_url):
    ...
    assert browser.find_elements(By.CSS_SELECTOR, ".panel-title")
